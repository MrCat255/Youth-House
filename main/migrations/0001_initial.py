    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to='static/user/images/', verbose_name='Аватарка')),
                ...
                ('gender', models.BooleanField(default=None, null=True, verbose_name='Пол')),
                ('birthday', models.DateField(blank=True, null=True, verbose_name='День рождения')),
                ('about_me', models.TextField(blank=True, max_length=250, null=True, verbose_name='О себе')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Активационный токен',
                'verbose_name_plural': 'Активационные токены',
            },
        ),
    ]
